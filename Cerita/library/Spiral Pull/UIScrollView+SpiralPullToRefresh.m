...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor colorWithRed:0.933 green:0.949 blue:0.918 alpha:1];;
        ...
        bottomLeftView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
        ...
        middleLeftView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
        ...
        middleRightView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
        ...
        middleCenterView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
        ...
        topLeftView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
        ...
        topRightView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
        ...
        topCenterView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
...
- (void)doAnimationStepForRandomWaitingAnimation {
    ...
    for (int i=0; i<self.particles.count; i++) {
        ...
        particleView.backgroundColor = (i == idx) ? [UIColor whiteColor] : [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
    }
}
...
- (void)doAnimationStepForLinearWaitingAnimation {
    ...
    for (int i=0; i<self.particles.count; i++) {
        ...
        if (particleView.backgroundColor == [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1]) {
            startIdx = i;
            break;;
        }
    }
    ...
    for (int i=0; i<self.particles.count; i++) {
        ...
        if (i == prevIdx) {
            particleView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
        } else if (i == startIdx) {
            particleView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
        } else {
            particleView.backgroundColor = [UIColor colorWithRed:0.267 green:0.678 blue:0.82 alpha:1];
